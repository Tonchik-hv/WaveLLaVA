...
from models_level import VisualToGPTMapping, initialize_special_embs
from dataset_level import get_dataset, get_collate_function
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default='./configs_level/config-pretrain_level.json')
    ...
    projection = VisualToGPTMapping(48, cfg.emb_dim).to(dtype=torch.float32)
