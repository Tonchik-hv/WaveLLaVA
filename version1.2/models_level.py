...
class ConvQ(nn.Module):
    def __init__(self, in_ch, out_ch):
        super().__init__()
        self.Q1 = nn.Conv2d(in_ch, in_ch, kernel_size = 3, stride = 1, padding = 1)
        self.Q2 = nn.Conv2d(in_ch, 125, kernel_size = 3, stride = 1, padding = 1)
        self.Q3 = nn.Conv2d(125, out_ch, kernel_size = 3, stride = 1, padding = 1)
    ...
    def forward(self, x):
        ...
        out = self.norm(out6.flatten(2).permute(0, 2, 1))
