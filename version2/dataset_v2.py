...
# def apply_template(d):
#     image = d['image']
#     latex = d['latex_formula']
#     return {
#         'image': image,
#         'conversations': [ 
#             {'from': 'human', 'value': ''},
#             {'from': 'gpt', 'value': latex}
#         ]
#     }

def apply_template(image, latex):
    # image = d['image']
    # latex = d['latex_formula']
    return {
        'image': image,
...
class OmniDataset(Dataset):
    ...
    def __init__(self, cfg, tokenizer):
        ...
        self.json_data = load_dataset("OleehyO/latex-formulas", "cleaned_formulas")['train'][:100000]
    ...
    def __getitem__(self, idx):
        # data_item = apply_template(self.json_data[idx])
        image, latex = self.json_data['image'][idx], self.json_data['latex_formula'][idx]
        data_item = apply_template(image, latex)
        tokens = []
        masks = []
        positions = []
